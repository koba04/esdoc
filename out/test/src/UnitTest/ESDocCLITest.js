...
describe('ESDocCLI:', function () {
   ...
   */
  it('can execute with directory path', function () {
    var cliPath = _path2['default'].resolve('./src/cli.js');
    var dirPath = _path2['default'].resolve('./test/fixture/src');
    var argv = ['node', cliPath, dirPath];
    var cli = new _srcESDocCLIJs2['default'](argv);
    cli.exec();
    _fsExtra2['default'].removeSync('./_esdoc_');
    (0, _assert2['default'])(true);
  });
});