  ...
  _createClass(DocBuilder, [{
    ...
    value: function _findByName(name) {
      ...
      if (matched) {
        ...
        var _parentDoc = this._findByName(_parent, 'class')[0];
        if (_parentDoc && _parentDoc._custom_extends_chains) {
          var _iteratorNormalCompletion = true;
          var _didIteratorError = false;
          var _iteratorError = undefined;

          try {
            for (var _iterator = _parentDoc._custom_extends_chains[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
