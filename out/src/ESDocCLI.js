...
var ESDocCLI = (function () {
  ...
  _createClass(ESDocCLI, [{
     ...
     * @private
     */
    value: function _createConfigFromPath(targetPath) {
      targetPath = _path2['default'].resolve(targetPath);
      var stat = _fs2['default'].statSync(targetPath);
      var config = undefined;
      ...
      var readmeStat = null;
      try {
        readmeStat = _fs2['default'].statSync('./README.md');
      } catch (e) {}
